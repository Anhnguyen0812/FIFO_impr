...
DATA_DIRECTORY_CITY = './leftImg8bit'
DATA_LIST_PATH_EVAL = './foggy_zurich/Foggy_Zurich/lists_file_names/RGB_testv2_filenames.txt'
...
DATA_DIR_EVAL = './'
DATA_DIR_EVAL_FD = './Foggy_Driving'
NUM_CLASSES = 19 
RESTORE_FROM = 'no model'
SNAPSHOT_DIR = f'./snapshots/FIFO'
GT_DIR_FZ = './foggy_zurich/Foggy_Zurich'
GT_DIR_FD = './Foggy_Driving'
GT_DIR_CLINDAU = './gtFine/gtFine'
SET = 'val'
...
def get_arguments():
    ...
    parser.add_argument("--devkit-dir-fz", default='./foggy_zurich/Foggy_Zurich/lists_file_names') 
