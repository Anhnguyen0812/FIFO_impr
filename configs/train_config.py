...
DATA_DIRECTORY_CWSF = '/kaggle/input/fifo-dataset/leftImg8bit/leftImg8bit'
DATA_LIST_PATH_CWSF = '/kaggle/working/FIFO_impr/dataset/cityscapes_list/train_origin.txt'
DATA_LIST_RF = '/kaggle/input/fifo-dataset/foggy_zurich/Foggy_Zurich/lists_file_names/RGB_sum_filenames.txt'
